...
do_capture() {
    ...
    rpicam-still -o "$IR_PATH" -t 6500 --ev -3.0 --gain 2.0 --shutter 4500 --width 640 --height 640
    ...
    rpicam-still -o "$WHITE_PATH" -t 6000 --ev -1.3 --gain 4 --shutter 6000 --width 640 --height 640
